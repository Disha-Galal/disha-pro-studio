...
نسخة ويب عربية مبنية على وظائف معالجة النصوص في سكريبت Disha Galal. السكريبت الأصلي محفوظ دون تعديل داخل reference. هذه إعادة تنفيذ للوظائف المناسبة للمتصفح، وليست تشغيل Python على الخادم.
